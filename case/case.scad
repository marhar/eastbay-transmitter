//------------------------------------------------------------------------------
// case.scad -- main transmitter box.
//
...
module post(hh) {
  // post for screwing faceplace onto case.
...
module case() {
  ...
  difference() {
    ...
    // cutout on bottom for quicker prototype printing.  Comment out for final.
